...
const Js_Practice = () => {
  useEffect(() => {
    console.log("js practice component did mount");
    ...
    return () => {
      ...
      const conditonObj = input.students.filter((item) =>
        item.id > 20 ? item : ""
      );
      ...
      const replace = [
        ...studIds.slice(0, replaceAt),
        ele,
        ...studIds.slice(replaceAt + 1),
      ];
      const insert = [
        ...studIds.slice(0, insertAt),
        ele,
        ...studIds.slice(insertAt),
      ];
      const remove = [
        ...studIds.slice(0, deleteAt),
        ...studIds.slice(deleteAt + 1),
      ];
  ...
  return (
    ...
    >
      <p style={{ color: "whitesmoke" }}>Js_Practice</p>
      <button>
